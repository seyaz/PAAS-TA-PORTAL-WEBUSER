...
export class OrgMainService {
  ...
  getUserSpaceRoles2(spaceid : string){
    return this.commonService.doGet('/portalapi/' + this.apiversion + '/spaces/'+spaceid+'/user-roles2', this.commonService.getToken()).map((res: any) => {
      return res;
    });
  }
